...
{
    public class CustomerCreatedPublisher:RabbitMqIntegrationEventPublisherBase<CustomerCreatedIntegrationEvent,CustomerCreatedIntegrationEventDto>
    {
        ...
        public CustomerCreatedPublisher(
        ...
        public override CustomerCreatedIntegrationEventDto ToIntegrationEventDto(CustomerCreatedIntegrationEvent integrationEvent)
        {
            var dto = mapper.Map<CustomerAggregate, CustomerCreatedIntegrationEventDto>(integrationEvent.Customer);
